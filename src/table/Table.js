...
function Table() {
	...
	const [ dragOverElemKey, setDragOverElemKey ] = useState('');
	const [ dropElemKey, setDropElemKey ] = useState('');

	const onDragEnd = () => {
		console.log('onDragEnd   dragedElemKey = ' + dragedElemKey + '  dragOverElemKey = ' + dragOverElemKey);
	};
	const onDrop = (elemKey) => {
		setDropElemKey(elemKey);
		console.log('onDrop   elemKey = ' + elemKey);
	};

	console.log('dragedElemKey = ' + dragedElemKey + '  dragOverElemKey = ' + dragOverElemKey);
	...
	return (
		<div>
						...
						<tr>
							...
							<td>
								<Cell
									...
									setDragOverElemKey={setDragOverElemKey}
									onDrop={onDrop}
									onDragEnd={onDragEnd}
									key="H"
									elem="H"
			...
			<div>
				...
				<div>{'dragOverElemKey = ' + dragOverElemKey}</div>
